...
const blankProfile: RiderProfile = { full_name: '', avatar_url: null, home_city: '', bio: '', username: 'rider', interests: [], locale: 'ru', theme_preference: 'dark' };
...
export function SettingsPage() {
  ...
  const refresh = useCallback(async () => {
    ...
    setProfile(nextProfile ? { ...nextProfile, theme_preference: 'dark' } : blankProfile);
  ...
  async function save(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      const nextProfile = { ...profile, username, theme_preference: 'dark' as const };
