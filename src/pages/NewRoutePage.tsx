...
export function NewRoutePage() {
  ...
  async function generateRouteCopy() {
    ...
    try {
      ...
      setMessage(locale === 'en' ? 'Gemini prepared the route copy. Check it before publishing.' : locale === 'kz' ? 'Gemini бағыт мәтінін дайындады. Жарияламас бұрын тексер.' : 'Gemini подготовил текст маршрута. Проверь его перед публикацией.');
    } catch (error) {
