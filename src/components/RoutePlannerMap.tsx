...
export function RoutePlannerMap({ points, waypoints, onAdd, routing }: { points: RoutePoint[]; waypoints: RoutePoint[]; onAdd: (point: RoutePoint) => void; routing: boolean }) {
  ...
  return (
    <MapContainer center={[43.2389, 76.8897]} zoom={11} zoomSnap={0.0625} zoomDelta={0.125} wheelPxPerZoomLevel={720} touchZoom="center" scrollWheelZoom className="route-map planner-map">
      <CommunityTileLayer />
